...
class Bebida {
    ...
    public static function getBebidas($pagina = 0, $paginasVisualizadas = 10, $orden=null, $dir=null, $filtro=null, $valor=null, $filtro2=null) {
        ...
        if ($filtro !== "" && $filtro !== null && $valor !== "" && $valor !== null) {
            ...
            $cuentaFilas = "SELECT count(id) FROM bebida WHERE LOWER($filtro) LIKE LOWER('%$valor%')";

        } else {  // Si el filtro viene vacio
            // Sentencia Select
            $seleccion = "SELECT * FROM bebida";
            $cuentaFilas = "SELECT count(id) FROM bebida";
        }
